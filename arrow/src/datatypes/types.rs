...
make_type!(Int96Type, i128, DataType::Int96);
...
make_type!(Int96Decimal0Type, i128, DataType::Int96Decimal(0));
make_type!(Int96Decimal1Type, i128, DataType::Int96Decimal(1));
make_type!(Int96Decimal2Type, i128, DataType::Int96Decimal(2));
make_type!(Int96Decimal3Type, i128, DataType::Int96Decimal(3));
make_type!(Int96Decimal4Type, i128, DataType::Int96Decimal(4));
make_type!(Int96Decimal5Type, i128, DataType::Int96Decimal(5));
make_type!(Int96Decimal10Type, i128, DataType::Int96Decimal(10));
