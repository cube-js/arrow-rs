...
make_numeric_type!(Int96Type, i128, i128x4, m128x4);
...
make_numeric_type!(Int64Decimal10Type, i64, i128x4, m128x4);
make_numeric_type!(Int96Decimal0Type, i128, i128x4, m128x4);
make_numeric_type!(Int96Decimal1Type, i128, i128x4, m128x4);
make_numeric_type!(Int96Decimal2Type, i128, i128x4, m128x4);
make_numeric_type!(Int96Decimal3Type, i128, i128x4, m128x4);
make_numeric_type!(Int96Decimal4Type, i128, i128x4, m128x4);
make_numeric_type!(Int96Decimal5Type, i128, i128x4, m128x4);
make_numeric_type!(Int96Decimal10Type, i128, i128x4, m128x4);
