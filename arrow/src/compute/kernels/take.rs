    ...
    IndexType::Native: ToPrimitive,
{
    ...
    match values.data_type() {
        ...
        DataType::Int96 => downcast_take!(Int96Type, values, indices),
        ...
        DataType::Int96Decimal(0) => downcast_take!(Int96Decimal0Type, values, indices),
        DataType::Int96Decimal(1) => downcast_take!(Int96Decimal1Type, values, indices),
        DataType::Int96Decimal(2) => downcast_take!(Int96Decimal2Type, values, indices),
        DataType::Int96Decimal(3) => downcast_take!(Int96Decimal3Type, values, indices),
        DataType::Int96Decimal(4) => downcast_take!(Int96Decimal4Type, values, indices),
        DataType::Int96Decimal(5) => downcast_take!(Int96Decimal5Type, values, indices),
        DataType::Int96Decimal(10) => downcast_take!(Int96Decimal10Type, values, indices),
